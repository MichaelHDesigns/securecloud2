...
EXCLUDE = [
    # auto generated:
    'src/qt/securecloud2strings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The SecureCloud2 developers'
...
Arguments:
    <base_directory> - The base directory of a securecloud2 source code repository.
"""
