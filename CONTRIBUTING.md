Contributing to SecureCloud2 Core
============================

The SecureCloud2 Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/securecloud2-project/securecloud2/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SecureCloud2 Core project, and is not to be
confused with overall SecureCloud2 Network Protocol consensus changes.

Whether a pull request is merged into SecureCloud2 Core rests with the project merge
...
Patches that change SecureCloud2 consensus rules are considerably more involved than
...
Where a patchset proposes to change the SecureCloud2 consensus, it must have been
...
The project leader is the release manager for each SecureCloud2 Core release.
