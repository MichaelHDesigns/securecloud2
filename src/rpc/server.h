...
extern UniValue DoZscnSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzscnseed(const UniValue& params, bool fHelp);
extern UniValue getzscnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzscn(const UniValue& params, bool fHelp);
extern UniValue dzscnstate(const UniValue& params, bool fHelp);
