...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SecureCloud2 server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "SecureCloud2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SecureCloud2 features */
        {"securecloud2", "listmasternodes", &listmasternodes, true, true, false},
        {"securecloud2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"securecloud2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"securecloud2", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"securecloud2", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"securecloud2", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"securecloud2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"securecloud2", "masternodedebug", &masternodedebug, true, true, false},
        {"securecloud2", "startmasternode", &startmasternode, true, true, false},
        {"securecloud2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"securecloud2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"securecloud2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"securecloud2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"securecloud2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"securecloud2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"securecloud2", "preparebudget", &preparebudget, true, true, false},
        {"securecloud2", "submitbudget", &submitbudget, true, true, false},
        {"securecloud2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"securecloud2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"securecloud2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"securecloud2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"securecloud2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"securecloud2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"securecloud2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"securecloud2", "checkbudgets", &checkbudgets, true, true, false},
        {"securecloud2", "mnsync", &mnsync, true, true, false},
        {"securecloud2", "spork", &spork, true, true, false},
        {"securecloud2", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzsc2seed", &getzsc2seed, false, false, true},
        {"zerocoin", "setzsc2seed", &setzsc2seed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzsc2", &searchdzsc2, false, false, true},
        {"zerocoin", "dzsc2state", &dzsc2state, false, false, true},
...
{
    return "> securecloud2-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26209/\n";
}
