...
#ifndef SecureCloud2_ZSCNWALLET_H
#define SecureCloud2_ZSCNWALLET_H
...
public:
    CzSCNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSCN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSCN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //SecureCloud2_ZSCNWALLET_H
