...
#ifndef SecureCloud2_ZSC2WALLET_H
#define SecureCloud2_ZSC2WALLET_H
...
public:
    CzSC2Wallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSC2(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSC2(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //SecureCloud2_ZSC2WALLET_H
