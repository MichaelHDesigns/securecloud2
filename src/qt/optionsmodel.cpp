...
// Wallet
    ...
    if (settings.contains("nAnonymizeSecureCloud2Amount"))
        SoftSetArg("-anonymizesecurecloud2amount", settings.value("nAnonymizeSecureCloud2Amount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in securecloud2.cpp during shotdown to also remove the window positions
