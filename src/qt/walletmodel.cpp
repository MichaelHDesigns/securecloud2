...
static void NotifyzSC2Reset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzSC2Reset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzSC2Reset.connect(boost::bind(NotifyzSC2Reset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzSC2Reset.disconnect(boost::bind(NotifyzSC2Reset, this));
