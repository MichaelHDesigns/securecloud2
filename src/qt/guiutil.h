...
/** Utility functions used by the SecureCloud2 Qt UI.
 */
namespace GUIUtil
{
...
// Render SecureCloud2 addresses in monospace font
...
// Parse "securecloud2:" URI into recipient object, return true on successful parsing
