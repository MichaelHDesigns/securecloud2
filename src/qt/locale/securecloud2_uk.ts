...
<context>
    ...
    <message>
        ...
        <translation>SecureCloud2 зараз закриється, щоб завершити процес шифрування. Пам'ятайте, що шифрування гаманця не може повністю захистити ваші SCN'и від крадіжки зловмисним програмним забезпеченням, що заражає ваш комп'ютер.</translation>
    </message>
    <message>
