...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SecureCloud2 Core"),
     ...
     * override -datadir in the securecloud2.conf file in the default data directory
     * (to be consistent with securecloud2d behavior)
     */
    if (dataDir != getDefaultDataDirectory())
