...
/* SecureCloud2 GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SecureCloud2"
#define QAPP_ORG_DOMAIN "securecloud2.org"
#define QAPP_APP_NAME_DEFAULT "SecureCloud2-Qt"
#define QAPP_APP_NAME_TESTNET "SecureCloud2-Qt-testnet"
