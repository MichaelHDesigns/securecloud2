                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zSCN || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    if (context == Context::Send_SCN || context == Context::Send_zSCN) {
