                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zSC2 || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending SC2 because you wouldn't check it anyway.
    if (context == Context::Send_SC2 || context == Context::Send_zSC2) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("SecureCloud2 will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your SC2s from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
