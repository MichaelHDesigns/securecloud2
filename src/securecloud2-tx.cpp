...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SecureCloud2 Core securecloud2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  securecloud2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securecloud2 transaction") + "\n" +
                               "  securecloud2-tx [options] -create [commands]   " + _("Create hex-encoded securecloud2 transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded securecloud2 transaction
