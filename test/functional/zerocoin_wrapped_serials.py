...
from fake_stake.base_test import SecureCloud2_FakeStakeTest

class zSCNwrappedSerialsTest(SecureCloud2_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSCNs..." % DENOM_TO_USE)
